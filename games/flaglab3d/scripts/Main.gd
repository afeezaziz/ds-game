extends Node3D
## FlagLab3D shell: a museum of FLAGSHIP 3D genres — the shapes behind the
...
const DEMOS := {
	"moba": {"title": "MOBA", "era": "lane · minions · abilities · towers", "script": preload("res://scripts/demos/Moba.gd")},
	"battleroyale": {"title": "BATTLE ROYALE", "era": "loot · shrinking zone · last alive", "script": preload("res://scripts/demos/BattleRoyale.gd")},
	"heist3d": {"title": "OPEN WORLD", "era": "drive · shoot · wanted · escape", "script": preload("res://scripts/demos/Heist3D.gd")},
	"voxel": {"title": "VOXEL BUILDER", "era": "mine · place · craft · night mobs", "script": preload("res://scripts/demos/Voxel.gd")},
	"covershoot": {"title": "COVER SHOOTER", "era": "stick to cover · peek · advance", "script": preload("res://scripts/demos/CoverShoot.gd")},
	"stealth": {"title": "STEALTH", "era": "vision cones · takedowns · alert", "script": preload("res://scripts/demos/Stealth.gd")},
	"musou": {"title": "MUSOU HORDE", "era": "mow crowds · combos · musou gauge", "script": preload("res://scripts/demos/Musou.gd")},
	"grapple": {"title": "GRAPPLE SWING", "era": "swing · momentum · traverse", "script": preload("res://scripts/demos/Grapple.gd")},
	"rocketcar": {"title": "ROCKET CAR", "era": "car football · boost · aerials", "script": preload("res://scripts/demos/RocketCar.gd")},
	"rts": {"title": "RTS", "era": "select · produce · raze the base", "script": preload("res://scripts/demos/RTS.gd")},
}
const ORDER := ["moba", "battleroyale", "heist3d", "voxel", "covershoot",
...
func _build_ui() -> void:
	...
	_lbl(v, "FLAGLAB 3D", 68, Color.WHITE)
	_lbl(v, "flagship 3D genres · pick an exhibit", 24, Color(1, 1, 1, 0.55))
	var sp := Control.new()
